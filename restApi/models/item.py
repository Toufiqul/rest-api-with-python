...
class ItemModel(db.Model):
    ...
    store_id = db.Column(db.Integer,db.ForeignKey("stores.id"), nullable=False) #db.ForeignKey("stores.id") to specify stores table's id is a foreign key in items table
